    ...
    public partial class frm_grafpieDiseño : Form
    {
        ...
        private void frm_grafpieDiseño_Load(object sender, EventArgs e)
        {
          ...
          * Fecha: 09/10/2016*/
            ...
            chart1.Titles.Add(texto).Font = new System.Drawing.Font("Century Gothic", 26, FontStyle.Bold); //Fuente, tamaño y estilo del título
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //----------------------- Carne: 0901-12-4321 -------------------------------------//
            //------------------------Funcion elimina grafica generada y limpia cadenas para que puedan utlizarse en una nueva grafica--------//
            if (chart1 != null)
            {
                chart1.Series.Clear();
                _listx.Clear();
