...
{
    public partial class frm_calculo_horas : Form
    {
        public frm_calculo_horas()
        {
            InitializeComponent();
        }
        ...
        public frm_calculo_horas(DataGridView gb, String id_devengo, String fecha, String nom_d, String des_d, String cant_d,String cant_h,String id_emp,String Precio, Boolean Editar1)
        {
                this.dg = gb;
                this.Editar = Editar1;
                this.codigo = id_devengo;
                InitializeComponent();
                if (Editar == true)
                {
        ...
        private void frm_calculo_horas_Load(object sender, EventArgs e)
        {
        ...
        capa_negocio ca = new capa_negocio();
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            if (Editar)
            {
               ca.ModificarHoraExtra(codigo,dt_fecha.Value.ToString("yyyy-MM-dd"),txt_nom.Text,txt_des.Text,txt_can_d.Text,txt_can_h.Text,cbo_empleado.SelectedValue.ToString());
                limpiar("e");
                btn_actualizar.PerformClick();
            }
            else
            {
                ca.InsertarHoraExtra(dt_fecha.Value.ToString("yyyy-MM-dd"),txt_nom.Text,txt_des.Text,txt_can_d.Text,txt_can_h.Text,cbo_empleado.SelectedValue.ToString());
                limpiar("e");
                btn_actualizar.PerformClick();
            }
        }
        ...
        private void txt_can_d_TextChanged(object sender, EventArgs e)
        {

        }

        private void cbo_por_DropDownClosed(object sender, EventArgs e)
        {
