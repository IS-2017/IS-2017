...
namespace contrato_trabajo
{
    public partial class frm_emp_telefonos : Form
    {
        ...
        //=======================================================================================================================
        //programador:Javier Figueroa Pereira
        private void txt_telefono_1_Leave(object sender, EventArgs e)
        {
            try
            {
                Regex phoneNumpattern = new Regex(@"^[0-9]{8}$");
                if (phoneNumpattern.IsMatch(txt_telefono_1.Text))
                {
                ...
                else
                {
                    ...
                    errorProvider1.SetError(this.txt_telefono_1, "Numero ingresado no valido");
                    return;
                }
            }
            catch (Exception ex)
        ...
        public void Validacion_Numeros(KeyPressEventArgs e)
        {
            try
            {
                ...
                {
                    e.Handled = true;
                    MessageBox.Show("Solo numeros son permitidos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
        ...
        private void txt_detalle_telefono_KeyPress(object sender, KeyPressEventArgs e)
        {
