...
namespace contrato_trabajo
{
    public partial class mdi_contenedor : Form
    {
        ...
        frm_producto_grid frm_prod;
        frm_proveedor_grid frm_prov;
        frm_facturacion frm_fact;
        ...
        private void productosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (frm_prod == null)
            {
                frm_prod = new frm_producto_grid();
                frm_prod.MdiParent = this;
                frm_prod.FormClosed += new FormClosedEventHandler(frm_prod_ex_FormClosed);
                frm_prod.Show();
            }
        }

        void frm_prod_ex_FormClosed(object sender, EventArgs e)
        {
            frm_prod = null;
        }
        ...
        private void proveedorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (frm_prov == null)
            {
                frm_prov = new frm_proveedor_grid();
                frm_prov.MdiParent = this;
                frm_prov.FormClosed += new FormClosedEventHandler(frm_prov_FormClosed);
                frm_prov.Show();
            }
        }

        void frm_prov_FormClosed(object sender, EventArgs e)
        {
            frm_prov = null;
        }
        ...
        private void facturaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (frm_fact == null)
            {
                frm_fact = new frm_facturacion();
                frm_fact.MdiParent = this;
                frm_fact.FormClosed += new FormClosedEventHandler(frm_fact_FormClosed);
                frm_fact.Show();
            }
        }

        void frm_fact_FormClosed(object sender, EventArgs e)
        {
            frm_fact = null;
        }
    }
