...
namespace MDI_CORTO_MIERCOLES_17
{
    public partial class prueba : Form
    {
        ...
        public prueba(DataGridView gb, String id_social, String p_laboral, String p_patronal, String fecha, String empresa, Boolean Editar1)
        {
            this.dg = gb;
            this.Editar = Editar1;
        ...
        private void btn_nuevo_Click(object sender, EventArgs e)
        {
            ...
            //c//n.llenar_id_empresa(cbo_empresa);
            //cbo_empresa.SelectedIndex = -1;
        }
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            if (Editar)
            {
                cp.ModificarSocial(codigo, txt_p_laboral.Text, txt_p_patronal.Text, dt_fecha.Value.ToString("yyyy-MM-dd"), cbo_empresa.SelectedValue.ToString());
            }
            else
            {
                cp.InsertarSocial(txt_p_laboral.Text, txt_p_patronal.Text, dt_fecha.Value.ToString("yyyy-MM-dd"), cbo_empresa.SelectedValue.ToString());
            }
        }
