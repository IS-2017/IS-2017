        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (actualizar == false)
                {
                    ...
                    if (txt_apellidos.Text == "" || txt_correo.Text.Trim() == "" || txt_movil.Text == "" || txt_nombres.Text == "" || txt_telefono.Text == "" || txt_nit.Text =="")
                    {
                    ...
                    else
                    {
                        ...
                        CapaDatosPersonas inserta = new CapaDatosPersonas();
                        inserta.InsertarNuevoCliente(txt_nombres.Text.Trim(), txt_apellidos.Text.Trim(),txt_movil.Text.Trim(),txt_telefono.Text.Trim(),txt_correo.Text.Trim(),txt_nit.Text.Trim()
                        );
