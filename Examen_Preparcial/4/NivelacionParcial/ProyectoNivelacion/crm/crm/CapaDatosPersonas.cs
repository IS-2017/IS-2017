...
namespace crm
{
    public class CapaDatosPersonas
    {
        ...
        public void InsertarNuevoCliente(string nombres, string apellidos,string movil, string telefono, string correo, string nit)
        {
            String cadena = "insert into tbl_cliente(nombres,apellidos,movil,telefono,correo,nit)values('"+nombres+"','"+apellidos+"','"+movil+"','"+telefono+"','"+correo+"','"+nit+"')";
        ...
        //1.  Insercion de nuevo proveedor
        public void InsertarNuevoProveedor(string empresa, string movil, string telefono, string correo, string nit)
        {
            String cadena = "insert into tbl_proveedor(empresa,movil,telefono,correo,nit)values('" + empresa + "','" + movil + "','" + telefono + "','" + correo + "','" + nit + "')";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        //1.  Insercion de nuevo producto
        public void InsertarNuevoProducto(string producto, string categoria, string medida, string descripcion,string precio)
        {
            String cadena = "insert into tbl_producto(producto,categoria,medida,descripcion,valor)values('" + producto + "','" + categoria + "','" + medida + "','" + descripcion + "','"+precio+"')";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        }
        //2.  Consulta de los productos ingresados
        public DataTable SeleccionarListaProductos()
        {
            String cadena = "select * from tbl_producto";
        ...
        //2.  Consulta de los proveedores ingresados
        public DataTable SeleccionarListaProveedores()
        {
            String cadena = "select * from tbl_proveedor";
            DataTable contenedor = new DataTable();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            OdbcDataAdapter adap = new OdbcDataAdapter(cmd);
            adap.Fill(contenedor);
        ...
        //1.  Insercion de nuevo producto
        public void InsertarNuevoEncabezadoDetalle(string encargado)
        {
            String cadena = "insert into tbl_enca_pedido(encargado,fecha)values('" + encargado + "', sysdate())";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        // 2. Consulta para traer el ultimo valor ingresado por parte del encabezado de formula
        public DataTable SeleccionUltimoDatoDetalle()
        {
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            string cadena = "select max(id_enca_pedido) from tbl_enca_pedido";
        ...
        //1.  Insercion de nuevo detalle pedido
        public void InsertarNuevoDetallePedido(string id_enca, string cantidad, string producto, string precio, string proveedor, string telefono)
        {
            String cadena = "insert into tbl_detalle_pedido (id_enca_pedido,cantidad,producto,precio,proveedor,telefono)values('" + id_enca + "','" + cantidad + "','" + producto + "','" + precio + "','"+proveedor+"','"+telefono+"')";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        // --------------------------------Area de factura
        //1.  Insercion de nuevo producto
        public void InsertarNuevoEncabezadoFactura(string cliente,string apellidios, string total )
        {
            String cadena = "insert into tbl_enca_factura(cliente,apellidos,total,fecha)values('" + cliente + "','"+apellidios+"','"+total+"', sysdate())";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        // 2. Consulta para traer el ultimo valor ingresado por parte del encabezado de formula
        public DataTable SeleccionUltimoDatoDetalleFactura()
        {
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            string cadena = "select max(id_enca_factura) from tbl_enca_factura";
            DataTable dt = new DataTable();
            OdbcCommand cmd = new OdbcCommand(cadena, con);
            OdbcDataAdapter adap = new OdbcDataAdapter(cmd);
            adap.Fill(dt);
        ...
        //1.  Insercion de nuevo detalle pedido
        public void InsertarNuevoDetalleFactura(string id_enca, string cantidad, string producto, string precio)
        {
            String cadena = "insert into tbl_detalle_factura (id_enca_factura,cantidad,producto,precio)values('" + id_enca + "','" + cantidad + "','" + producto + "','" + precio + "')";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        {
            String cadena = "update tbl_inventario set cantidad = '" + cantidad + "' where producto='" + producto + "'";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        }
        //2.  Consulta de los cantidad de productos
        public DataTable SeleccionarCantidadInventario(string producto)
        {
            String cadena = "select cantidad from tbl_inventario where producto ='"+producto+"';";
            DataTable contenedor = new DataTable();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            OdbcDataAdapter adap = new OdbcDataAdapter(cmd);
            adap.Fill(contenedor);
        ...
        // select cliente,apellidos,total,fecha from tbl_enca_factura;
        //2.  Consulta de los cantidad de productos
        public DataTable bitacora_ventas()
        {
            String cadena = "select cliente,apellidos,total,fecha from tbl_enca_factura;";
            DataTable contenedor = new DataTable();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            OdbcDataAdapter adap = new OdbcDataAdapter(cmd);
            adap.Fill(contenedor);
        ...
        //select * from tbl_Enca_pedido;
        //2.  Consulta de los cantidad de productos
        public DataTable bitacora_compras()
        {
            String cadena = "select * from tbl_Enca_pedido;";
            DataTable contenedor = new DataTable();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            OdbcDataAdapter adap = new OdbcDataAdapter(cmd);
            adap.Fill(contenedor);
        ...
        //1.  Insercion de nuevo registro en inventario
        public void InsertarNuevoRegistroInventario(string producto, string cantidad, string categoria, string medida, string descripcion)
        {
            String cadena = "insert into tbl_inventario(producto,cantidad,categoria,medida,descripcion)values('" + producto + "','" + cantidad + "','" + categoria + "','" + medida + "','" + descripcion + "');";
            OdbcConnection con = seguridad.Conexion.ObtenerConexionODBC();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        //2.  Consulta de los cliente segun nit
        public DataTable SeleccionarClienteSegunNit(string nit)
        {
            String cadena = "select id_cliente,nombres,apellidos from tbl_cliente where nit ='" + nit + "';";
            DataTable contenedor = new DataTable();
            OdbcCommand cmd = new OdbcCommand(cadena, seguridad.Conexion.ObtenerConexionODBC());
            OdbcDataAdapter adap = new OdbcDataAdapter(cmd);
            adap.Fill(contenedor);
