    ...
    public class Conexion
    {
        ...
        public static OdbcConnection ObtenerConexionODBC()
        {
            ...
            try
            {
                ...
                con.ConnectionString = "dsn=proyectos; UID=" + user + "; PWD=" + password + "; ";
        ...
        public static OdbcConnection ObtenerConexionM()
        {
            ...
            try
            {
                ...
                con.ConnectionString = "dsn=proyectos;";
                con.Open();
                return con;
            }
        ...
        public static OdbcConnection DesconectarODBC()
        {
            OdbcConnection con = new OdbcConnection();
            //con.ConnectionString = "dsn=prueba2; database="+database+"; UID="+role+"; PWD="+password+"; ";
            con.ConnectionString = "dsn=proyectos; server=localhost; UID=" + user + "; PWD=" + password + "; ";
            con.Close();
            return con;
        }
        ...
        public static OdbcConnection ConexionPermisos()
        {
            ...
            try
            {
                OdbcConnection con = new OdbcConnection();
                //con.ConnectionString = "dsn=prueba2; database="+database+"; UID="+role+"; PWD="+password+"; ";
                con.ConnectionString = "dsn=proyectos; UID= dumpy; PWD=dumpy; ";
                con.Open();
                return con;
            }
            catch(Exception ex) { MessageBox.Show(ex.Message); return null; }
