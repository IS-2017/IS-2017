    ...
    public partial class frm_proveedor : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TextBox[] textbox = {txt_direc,txt_tele,txt_nombre };
        ...
        private void btn_editar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.txt_direc.Text = this.dataGridView1.CurrentRow.Cells[2].Value.ToString();
        ...
        private void btn_actualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                string tabla = "proveedor";
                fn.ActualizarGrid(this.dataGridView1, "Select * from proveedor where estado <> 'INACTIVO' ", tabla);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
