...
namespace Examen_Miercoles_17_de_Mayo
{
    class capa_datos
    {
        public void llenar_id_bien(ComboBox cb)
        {
            ...
            try
            {
                ...
                cmd = new OdbcCommand("select id_bien_pk, descripcion from bien where estado='ACTIVO'", con);
                OdbcDataAdapter adaptador = new OdbcDataAdapter(cmd);
                adaptador.Fill(dt);

                cb.DataSource = dt;
                cb.DisplayMember = "descripcion";
                cb.ValueMember = "id_bien_pk";
        ...
        public void llenar_proveedor(ComboBox cb)
        {
            ...
            try
            {
                ...
                cmd = new OdbcCommand("select id_proveedor, nombre_proveedor from proveedor", con);
                OdbcDataAdapter adaptador = new OdbcDataAdapter(cmd);
                adaptador.Fill(dt);
