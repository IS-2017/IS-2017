...
namespace Examen_Miercoles_17_de_Mayo
{
    class capa_negocio
    {
        ...
        public void Insertar_producto( string precio, string descripcion, string marca, string id_proveedor)
        {
            int resultado = ca.Ejecutar_Mysql("insert into bien(id_bien_pk,precio_venta,descripcion,marca, id_proveedor) values (null,'" + precio + "','" + descripcion + "','" + marca + "','"+ id_proveedor + "');");
        ...
        public void Modificar_producto(string id, string precio_venta, string descripcion, string marca)
        {
            int resultado = ca.Ejecutar_Mysql("update bien set precio_venta='" + precio_venta+ "',descripcion='" + descripcion + "',marca= '"+marca+"' where id_bien_pk='" + id + "';");
            if (resultado > 0)
            {
                MessageBox.Show("Modificacion Exitosa");
            }
